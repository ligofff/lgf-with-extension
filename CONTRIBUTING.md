...
1. Make an [Issue](https://github.com/ligofff/lgf-with-extension/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-with-extension": "https://github.com/YOUR_USER/lgf-with-extension.git"
        }
    }
```
